    ...
    <script>
                                        ...
                                        jQuery(function ($) {
                                            $('#fuelux-wizard').ace_wizard().on('change', function (e, info) {
                                                ...
                                                {
                                                    //修改表单提交地址
                                                    $('#Cform').attr('action', '<?php echo U('Collection/Admin/testlist'); ?>');
                                                ...
                                                if (info.step == 2 && info.direction == 'next')
                                                {
                                                    ...
                                                    $.ajax({
                                                        type: "post",
                                                        url: "<?php echo U('Collection/Admin/add'); ?>",
                                                ...
                                                {
                                                    $('#Cform').attr('action', '<?php echo U('Collection/Admin/testpage'); ?>');
                                                    $('#Cform').attr('target', '_bank');
                                                    var cateinfo = $('#cate').val().split(',');
                                                    $.ajax({
                                                        type: "post",
                                                        url: "<?php echo URL('Collection/Admin/getfields'); ?>",
                                                        data: {mid: cateinfo[1]},
                                                        dataType: "json",
                                                        success: function (data) {
                                                            var html = '';
